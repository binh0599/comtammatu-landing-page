...
export default function HeroButtons() {
    return (
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-2/5 flex flex-row gap-2 md:gap-2 justify-center animate-fade-in-up delay-500 w-auto z-20">
            ...
            <button onClick={() => window.dispatchEvent(new CustomEvent("open-booking"))} className="group relative w-[130px] md:w-[220px] bg-black/80 backdrop-blur-md border border-vang-dong hover:bg-vang-dong hover:text-black text-vang-dong font-semibold py-2.5 md:py-4 px-1 md:px-4 rounded-sm text-[9px] md:text-[12px] uppercase tracking-[0.1em] md:tracking-[0.15em] transition-all duration-300 shadow-[0_10px_20px_rgba(0,0,0,0.5)] text-center flex items-center justify-center overflow-hidden focus-visible:ring-2 focus-visible:ring-vang-dong focus-visible:outline-none touch-manipulation cursor-pointer">
