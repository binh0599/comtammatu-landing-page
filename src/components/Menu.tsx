...
import { menuGroups } from "@/lib/data";
...
const MenuCard = ({ card }: { card: CardData }) => {
    const formatPriceText = (priceText: string) => priceText;

    return (
        <div className="snap-center shrink-0 w-[240px] md:w-[280px] lg:w-[320px] relative group h-full">
            {/* Card Body */}
