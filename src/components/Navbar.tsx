    ...
    return (
        <header className={`fixed top-0 left-0 w-full z-50 pointer-events-none flex flex-col items-center px-4 md:px-8 transition-all duration-500 ease-in-out ${scrolled ? "pt-2 md:pt-2" : "pt-6 md:pt-10"
            ...
            >
                ...
                >
                    <div className={`relative rounded-full border-vang-kem group-hover:border-white transition-all duration-500 ease-in-out shadow-xl overflow-hidden bg-den ${scrolled ? "w-10 h-10 md:w-12 md:h-12 border-[1.5px]" : "w-20 h-20 md:w-28 md:h-28 border-[3px]"
                        }`}>
                        <Image
