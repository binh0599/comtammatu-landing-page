...
export default function Footer() {
    return (
        <footer id="footer" className="relative bg-[#1a1a1a] snap-end shrink-0 border-t border-vang-kem/20 overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-10 mix-blend-overlay pointer-events-none bg-[url('https://www.transparenttextures.com/patterns/rice-paper.png')]" />
            ...
            <div className="container mx-auto px-6 md:px-12 lg:px-24 py-16 md:py-24 relative z-10 text-vang-kem">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 mb-16">
                    ...
                    <div className="md:col-span-4 flex flex-col items-start gap-6 pr-4">
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="h-0.5 w-16 bg-vang-kem/50 mt-2"></div>
                        </div>
                        ...
                        <div className="flex gap-4 mt-2">
                            {/* Facebook icon */}
                            <a href="#" className="w-10 h-10 rounded-full border border-vang-kem/30 flex items-center justify-center text-vang-kem hover:bg-vang-kem hover:text-[#1a1a1a] transition-all duration-300">
                    ...
                    <div className="md:col-span-2 flex flex-col gap-5">
                        ...
                        {navLinks.map((link) => (
                            <a
                                key={link.label}
                                href={link.href}
                                className="text-vang-kem/80 font-mulish text-lg hover:text-white hover:translate-x-1 transition-all w-fit"
                            >
                                {link.label}
                            </a>
                        ))}
                    ...
                    <div className="md:col-span-3 flex flex-col gap-5 font-mulish">
                        ...
                        <div className="flex items-start gap-3">
                            <span className="text-[#cb9b51] mt-1 shrink-0">
                        ...
                        <div className="flex items-center gap-3">
                            <span className="text-[#cb9b51] shrink-0">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z" /></svg>
                            </span>
                            <a href="tel:+84772818172" className="text-vang-kem/90 hover:text-white transition-colors text-[15px] font-medium tracking-wide">
                                0772 818 172
                            </a>
                        </div>

                        <div className="flex items-start gap-3 mt-1">
                            <span className="text-[#cb9b51] mt-0.5 shrink-0">
                            ...
                            <div className="flex flex-col text-[15px]">
                                ...
                                <span className="text-vang-kem/60 text-sm">Thứ Hai - Chủ Nhật</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="md:col-span-3 flex flex-col h-full">
                        ...
                        <a
                            ...
                            className="text-center mt-3 text-sm text-[#cb9b51] hover:text-white transition-colors underline-offset-4 hover:underline"
                        >
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4 pt-8 border-t border-vang-kem/10 font-mulish">
                    <p className="text-vang-kem/60 text-sm">
                        © {new Date().getFullYear()} Cơm Tấm Má Tư. All rights reserved.
                    </p>
                    <p className="text-vang-kem/40 text-xs">
